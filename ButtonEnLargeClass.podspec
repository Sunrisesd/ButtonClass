Pod::Spec.new do |s| 
  s.name         = "ButtonEnLargeClass"				#SDK名称
  s.version      = "1.0.0"                        		#版本号
  s.homepage     = "https://github.com/Sunrisesd"  		#工程主页地址
  s.summary      = "扩大按钮响应范围工具类"  			#项目的简单描述
  s.license  	 = "MIT"  					#协议类型
  ...
  s.source       = { :git => "https://github.com/Sunrisesd/ButtonClass.git" ,:tag => "#{s.version}"}   						#工程地址及版本号
  s.requires_arc = true   					#是否必须arc
  s.source_files = "ButtonEnLargeTouchArea.swift"   		#SDK实际的重要文件路径
